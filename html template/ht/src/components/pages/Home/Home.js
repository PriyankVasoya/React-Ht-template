                     ...
                     <div className="carousel-caption relative">
                        <div className="row d_flex">
                           ...
                           <div className="col-md-6">
                              ...
                              <a className="get_btn" href="Javascript:void(0)" role="button">Get Appoinment</a>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div className="row">
               <div className="col-lg-8 offset-lg-2 col-md-12">
                  <div className="row">
                     ...
                     <div className="col-md-12">
                        <a className="read_more mar_top exper" href="Javascript:void(0)"> Read More</a>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div className="row">
               <div className="col-md-12">
                  <div className="map_main">
                     ...
                     <iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0s1a7phLN0iaD6-UE7m4qP-z21pH0eSc&q=Eiffel+Tower+Paris+France" width={600} height={386} frameBorder={0} style={{ border: 0, width: '100%' }} allowFullScreen />                     </div>
                  </div>
               </div>
            </div>
         </div>
